        ...
        <div className='px-4 py-2'>
            <Cards>
                ...
                <Link to={'/chat'} className={location.pathname === '/chat' ? activeclase : nonactiveclase}>
                    ...
                    Chat</Link>
                <Link to={'/saved'} className={location.pathname === '/saved' ? activeclase : nonactiveclase}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <Link to={'/notifications'} className={location.pathname === '/notifications' ? activeclase : nonactiveclase}>
                    ...
                    Alert</Link>
                <Link to={'/setings'} className={location.pathname === '/setings' ? activeclase : nonactiveclase}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
