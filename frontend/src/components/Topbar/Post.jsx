        ...
        <div>
            <Cards>
                <div className='flex gap-3'>
                    ...
                    <div className='grow'>
                        <p><Link to={'/profile'} className='font-semibold cursor-pointer hover:underline'>User </Link>shared a <Link to={'/post'} className='text-socialblue'>Photo</Link></p>
                ...
                <div className='flex mt-4 gap-3'>
                    ...
                    <div className='border grow rounded-full relative'>
                        <textarea className=' block w-full p-3 overflow-hidden px-4 h-12 ' placeholder='Leave a comment.'></textarea>
