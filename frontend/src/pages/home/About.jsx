            ...
            <Layout>
                    ...
                    <div className='relative overflow-hidden rounded-md'>
                        ...
                        <div className='p-4 '>
                            ...
                            <div className='mt-10 flex gap-5'>
                                ...
                                <Link to={'/profile/about'} className={activeclase}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                ...
                                <Link to={'/profile/friends'} className='flex gap-1 items-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                ...
                                <Link to={'/profile/photos'} className='gap-1 items-center hidden md:flex'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <div>
                    <Cards>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus possimus sint odit consequuntur ipsa officiis, in quas labore cumque aliquam magnam at, aperiam fuga, sapiente suscipit magni praesentium assumenda accusamus!</p>
                    </Cards>
                </div>
