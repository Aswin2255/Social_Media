        ...
        <div>
                    ...
                    <div className='relative overflow-hidden rounded-md'>
                        ...
                        <div className='p-4 '>
                            ...
                            <div className='mt-10 flex gap-5'>
                                ...
                                <Link to={'/profile/friends'} className={tabclases}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                ...
                                <Link to={'/profile/photos'} className={activeclase}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className='grid grid-cols-2 gap-4'>
                <div className='rounded-md overflow-hidden h-48 flex items-center shadow-md'>
                    <img src='https://images.unsplash.com/photo-1601581875039-e899893d520c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80' alt='pic'></img>
                </div>
                <div className='rounded-md overflow-hidden h-48 flex items-center shadow-md'>
                    <img src='https://images.unsplash.com/photo-1601581875039-e899893d520c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80' alt='pic'></img>
                </div>
